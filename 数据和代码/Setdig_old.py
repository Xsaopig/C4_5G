...
file_path = 'C:\\Users\\xsaopig\\Desktop\\5G承载网项目\\5G承载网故障检测数据\\Data\\t_alarmlogcur.csv'
...
if __name__ == '__main__':
    ...
    for i in range(len(locs)):
        timelist.append(dp.getoccurtimelist(dataByloc[locs[i]]))
    ...
    #         for loc in l:
    #             if a_found==False and loc.find(a)!=-1: 
    #                 a_found=True
    #             if b_found==False and loc.find(b)!=-1: 
    #                 b_found=True
